export const posts = [
  {
    ...
    date: "2025-11-28",
    author: "张三",
    excerpt: "Vue 3 是一款流行的 JavaScript 框架，本文将带你快速入门 Vue 3 的核心概念和使用方法。",
    content: `
      <h3>什么是 Vue 3？</h3>
...
npm run dev</code></pre>
  ...
  },
  {
    ...
    date: "2025-11-25",
    author: "李四",
    excerpt: "异步编程是 JavaScript 开发中的重要概念，本文将介绍异步编程的最佳实践和常用模式。",
    content: `
      <h3>异步编程的重要性</h3>
  ...
  },
  {
    ...
    date: "2025-11-20",
    author: "王五",
    excerpt: "CSS Grid 是一种强大的二维布局系统，本文将详细介绍 CSS Grid 的各种属性和使用方法。",
    content: `
      <h3>CSS Grid 简介</h3>
